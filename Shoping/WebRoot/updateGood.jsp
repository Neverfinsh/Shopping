							...
							<div>
								<div id="user-profile-1" class="user-profile row">
									...
									<div class="col-xs-12 col-sm-9">
										...
										<div id="dropzone">
											<form action="modifyGoods" class="dropzone dz-clickable" enctype="multipart/form-data"
											method="post">

												          商品名称:<input type="text" class="form-control "
													name="goodsname" value="${requestScope.good.goodsname }"><br> 
													商品价格:<input type="text"
													class="form-control" name="price" value="${requestScope.good.price }"><br> 
													商品数量:<input type="text" class="form-control" name="count" value="${requestScope.good.count }"><br>
												...
												<div class="input-append">
												 <img
												alt="150x150" src="upload/${requestScope.good.image }"
