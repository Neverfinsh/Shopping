					...
					<div class="container-flow" style="padding:0px; margin:0px">
						...
						<div class="container-flow"
							...
							<div class="row">
								<div class="col-lg-3 col-lg-offset-1">
									<span style="color:#ffffff;font-family:微软雅黑">搜索店内宝贝&nbsp;</span><input
										type="text">
								</div>
								<div class="col-lg-4" style="color:#ffffff;font-family:微软雅黑;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;welcome
									to our store,new products constantly happy shopping</div>
						...
						<div style="margin-top:38px">
							...
							<div class="col-md-2"
								...
								<br> <a href=""><img src="upload/${requestScope.good.image }"
									width="100%"></a> <br> <br> <br> <a href=""><img
									src="upload/${requestScope.good.image }" width="100%"></a> <br> <br>
								 <br> <br> <br> 
							</div>
